                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{brightness}%</div>
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{contrast}%</div>
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{saturation}%</div>
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">{opacity}%</div>
                    </div>
                  </div>
                )}
